...
func Subscriptions_regenerateprimarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSubscriptions_regenerateprimarykeyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscriptions_regenerateprimarykeyHandler(cfg),
	}
}
