...
func Subscriptions_regeneratesecondarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateSubscriptions_regeneratesecondarykeyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Subscriptions_regeneratesecondarykeyHandler(cfg),
	}
}
